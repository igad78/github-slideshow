<?php
// Set CSP headers via PHP — no .htaccess needed
header("Content-Security-Policy: default-src 'self'; script-src 'self' 'unsafe-inline' 'unsafe-eval' https://widgets.api-sports.io https://v3.football.api-sports.io; style-src 'self' 'unsafe-inline' https://widgets.api-sports.io; img-src 'self' data: blob: https://widgets.api-sports.io https://media.api-sports.io https://media-3.api-sports.io; connect-src 'self' https://v3.football.api-sports.io https://widgets.api-sports.io; font-src 'self' data: https://widgets.api-sports.io; frame-src 'self' https://widgets.api-sports.io;");
...
<div class="main-content">
  ...
  <div class="api-key-form">
    ...
    <div class="form-row">
      <input type="text" id="apiKeyInput" value="60b1062cf3a1814fa45b70eb155a3316" direction="ltr">
